window.addEventListener("DOMContentLoaded", () => {
  ...
  const playerWon = () => {
    if (
      emptyBox[0] === currentPlayer &&
      emptyBox[1] === currentPlayer &&
      emptyBox[2] === currentPlayer
    ) {
      return true;
    }
    if (
      emptyBox[0] === currentPlayer &&
      emptyBox[3] === currentPlayer &&
      emptyBox[6] === currentPlayer
    ) {
      return true;
    }
    if (
      emptyBox[0] === currentPlayer &&
      emptyBox[4] === currentPlayer &&
      emptyBox[8] === currentPlayer
    ) {
      return true;
    }
    if (
